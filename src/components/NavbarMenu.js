...
function NavbarMenu({ isLoggedIn, isAdmin, onLogout }) {
  ...
  const links = [
    ...
    { key: 'admin', to: '/admin', label: 'Admin', show: isLoggedIn, isButton: false },
    { key: 'orders', to: '/orders', label: 'Order', show: isLoggedIn, isButton: false },
    { key: 'pembukuan', to: '/pembukuan', label: 'Pembukuan', show: isLoggedIn, isButton: false },
  ];
